...
//    $headimg = blogtheme_imgurl($headimg);
    ...
    if ($headimg === False) $headimg = $a->get_baseurl()."/view/theme/blogga/img/headers/willow.jpg";
    ...
    <div id="page">
        <?php 
            if(x($page,'nav')){
                ...
                echo str_replace("~blog.header.image~", $headimg, 
                       str_replace("~config.sitename~",get_config('system','sitename'),
        ...
        <footer id="colophon" role="contentinfo">
            <div id="site-generator">
                <a rel="generator" title="Personal Communication Platform" href="http://redmatrix.me">Powered by redmatrix</a>
