// Include this file and adjust as necessary for alternate icon sets which use different icon names. kjkj
...
$(document).ready(function() {
		...
		$('.icon-th').addClass('');
		$('.icon-home').addClass('images/rarrow.gif');
		$('.icon-envelope').addClass('');
		$('.icon-calendar').addClass('');
		$('.icon-user').addClass('');
		$('.icon-exclamation').addClass('logo-play-header.png');
