...
<nav>
	...
	{{if $nav.network}}
		<li id="nav-network-link" class="nav-menu {{$sel.network}}">
			<a class="{{$nav.network.2}}" href="{{$nav.network.0}}" title="{{$nav.network.3}}" ><span class="icon matrix-icon"></span></a>
	...
	{{if $nav.home}}
		<li id="nav-home-link" class="nav-menu {{$sel.home}}">
			<a class="{{$nav.home.2}}" href="{{$nav.home.0}}" title="{{$nav.home.3}}" ><span class="icon home-icon"></span></a>
   ...
   {{if $nav.register}}<li id="nav-register-link" class="nav-menu {{$nav.register.2}}"><a href="{{$nav.register.0}}" title="{{$nav.register.3}}" >{{$nav.register.1}}</a><li>{{/if}}
	...
	{{if $nav.messages}}
		<li id="nav-mail-link" class="nav-menu {{$sel.messages}}">
			<a class="{{$nav.messages.2}}" href="{{$nav.messages.0}}" title="{{$nav.messages.3}}" ><span class="icon mail-icon"></span></a>
	...
	{{if $nav.all_events}}
		<li id="nav-all_events-link" class="nav-menu {{$sel.all_events}}">
			<a class="{{$nav.all_events.2}}" href="{{$nav.all_events.0}}" title="{{$nav.all_events.3}}" ><span class="icon events-icon"></span></a>
	...
	{{if $nav.intros}}
		<li id="nav-intros-link" class="nav-menu {{$sel.intros}}">
			<a class="{{$nav.intros.2}}" href="{{$nav.intros.0}}" title="{{$nav.intros.3}}" ><span class="icon intros-icon"></span></a>
	...
	{{if $nav.notifications}}
		<li id="nav-notify-linkmenu" class="nav-menu fakelink {{$sel.notifications}}">
			<a href="{{$nav.notifications.0}}" title="{{$nav.notifications.1}}"><span class="icon notifications-icon"></span></a>
	...
	{{if $nav.apps}}
		<li id="nav-apps-link" class="nav-menu {{$sel.apps}}">
			<a class=" {{$nav.apps.2}}" href="apps" title="{{$nav.apps.3}}" >{{$nav.apps.1}}</a>
		</li>
	{{/if}}
