...
<div id="profile-expire-wrapper" style="display: {{$feature_expire}};" >
	<a id="profile-expires" class="icon expire jot-icons" title="{{$expires}}" onclick="jotGetExpiry();return false;"></a>
</div>
<div id="profile-encrypt-wrapper" style="display: {{$feature_encrypt}};" >
	<a id="profile-encrypt" class="icon encrypt jot-icons" title="{{$encrypt}}" onclick="red_encrypt('{{$cipher}}','#profile-jot-text',$('#profile-jot-text').val());return false;"></a>
</div>
